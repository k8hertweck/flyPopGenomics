...
barplot(popSums, col=c("red","red","red","red","red","red 4","red 4","red 4","red 4","red 4","green","green","green","green","green","green 4","green 4","green 4","green 4","green 4","blue","blue","blue","blue","blue","blue 4","blue 4","blue 4","blue 4","blue 4"), names.arg = "", xlab="B       BO      CO      nCO     ACO     AO", ylab="number of de novo TE insertions", cex.lab=0.9, ylim = c(0, 1000))
